...
-- CreateEnum
CREATE TYPE "ShiftStatus" AS ENUM ('PENDING', 'CONFIRMED', 'REJECTED', 'COMPLETED');

-- CreateEnum
CREATE TYPE "TimesheetStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');

-- CreateEnum
CREATE TYPE "DocumentType" AS ENUM ('LICENSE', 'INSURANCE', 'CERTIFICATION', 'OTHER');
...
CREATE TABLE "Shift" (
    ...
    "mealBreak" BOOLEAN NOT NULL DEFAULT true,
    "cost" DOUBLE PRECISION NOT NULL,
    "chargeOut" DOUBLE PRECISION NOT NULL,
